  ...
  return (
    ...
    >
      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        {/*  text container */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:64 lg:w-2/3 lg:pr-0 xl:1/2">
          {/* boigraphy container */}
        ...
        <div className="hidden lg:block sticky top-0 z-30 w-1/3">
